...
<table class="table">
			...
			<th>Status</th>
            <th>Date To Return The Equipment</th>

            </tr>
            </thead>
<?php
	require_once 'dbconfig.php';
	$stmt = $db_con->prepare('SELECT e.Client_id, e.Location, e.DateCompleted, u.Total,  u.Client_id, u.Status FROM `project` AS e INNER JOIN `requestequipment` AS u ON e.Client_id = u.Client_id AND u.Status="Approved"');
	$stmt->execute();
